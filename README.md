...
* A file called `src/routes/about.svelte` corresponds to the `/about` route. A file called `src/routes/commerces/[slug].svelte` corresponds to the `/commerces/:slug` route, in which case `params.slug` is available to the route
