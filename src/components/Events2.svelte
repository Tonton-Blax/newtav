<script>
    ...
    import { dicoClass, getProp, writeWeather, timeState, getDefaultCategory } from '../utils/consts.js';
  ...
  <style>
    ...
    :global(.timeline .timeline-item::before) {
      left:-2rem;
    }
    :global(.timeline .timeline-item .timeline-marker) {
      height: 48px;
      width: 48px;
      left: -2rem;
      top:10rem;
