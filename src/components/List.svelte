<script>
    ...
    import { activeListItem, activeMapItem, mobileViewport } from '../utils/stores.js';
    import Collapse from '../bits/Collapse.svelte'
    import Modal from '../bits/Modal.svelte'
    import Footermax from './Footermax.svelte'
    import Draggableframes from "../bits/Draggableframes.svelte";
      ...
      <div class="card" class:glowing={index == $activeListItem || index == $activeMapItem}>
              <div class="card-image">
                  <figure class="image maximagecard" on:click={() => openModal(index)}>
                      <img src="{listItem.featured_image.src || 'pingouins.jpg'}" alt="Placeholder">
                  </figure>
              </div>
              <div class="card-content">
                  <div class="media">
                    ...
                    <img src={`./svg/cat/${handleDefaultCategory(listItem)}`} alt="Placeholder">  
