...
<script>
  ...
  import Marker from "../bits/Marker.svelte"
  import { activeListItem, activeMapItem, isBigArray, isScrolling } from '../utils/stores.js';
  import { onMount, onDestroy, setContext } from 'svelte';
  import { getProp, allHorairesHtml, dicoraireCouleurs, getDefaultCategory } from '../utils/consts';  
  import {dicoIcons} from '../utils/categories.js'
  import { mapbox, key } from '../bits/mapbox.js';
